...
/* Division */
// Division is easy to understand except for when the numerator and denominator are both ints.
int i9 = 10, i10 = 3;
...
\end{lstlisting}
\noindent This code creates an variable (often called ``object" in this case, since it is a class) in which we can call various methods on it to get input from the user. 
